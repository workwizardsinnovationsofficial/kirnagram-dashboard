...
const API_URL = "http://127.0.0.1:8000/admin/ai-creator/applications"; // Adjusted to match backend
...
const AICreatorRequests = () => {
  ...
  const handleApprove = async (id: string) => {
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/ai-creator/applications/${id}/approve`, {
        method: "POST",
      });
  ...
  const handleReject = async (id: string) => {
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/ai-creator/applications/${id}/reject`, {
        method: "POST",
      });
  ...
  const submitSuspend = async () => {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/ai-creator/applications/${selectedRequestId}/suspend`, {
        method: "POST",
  ...
  const submitBlock = async () => {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/ai-creator/applications/${selectedRequestId}/block`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleRevoke = async (id: string) => {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/ai-creator/applications/${id}/revoke`, {
        method: "POST",
      });
